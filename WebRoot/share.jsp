<%@ page language="java" import="java.util.*" import="java.sql.ResultSet" contentType="text/html; charset=utf8" %> 
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
$(document).ready(function(){
  ...
  fb.onclick=function(){
 var fabu=document.getElementById("fabu").value;
  if(fabu=="")
  {
	  alert("发布内容不能为空！");
  }
	...
	<div class="bg_1">
		<div class="bg_1_left">
			<div class="bg_1_left_top">
				<ul>
					<li><a href="toShare" class="active">全部分享</a></li>
		...
		<div class="bg_1_middle">
			<div class="bg_top">
				...
				<form action='publish'>
					<div class="top_1">
						<textarea name="text" id="fabu"></textarea>
					</div> 
					<div class="top_2">
						<form action='toShare'>
							<input type="submit" value="发布" id="fb"/>
						</form>
					</div>
				</form>
			</div>
					...
					%>
						<div class="share_content">
							...
							<div class="share_content_bottom">
								...
								<div id="dianji"><img  src="images/message.png" width="25px" height="21px" /><input type="submit" id="pinlun"/></div>
						   		 <span></span>
								<div id="tihuan"><img src="images/dianzan.png" width="25px" height="21px" /><input type="submit" id="dianzan"/></div>
						...
						<div class="say_bottom">
							<div class="say_bottom_pic">
								<img src="images/3.jpg" width="70px" height="70px"/>
							</div>
							<div class="say_bottom_text1">
