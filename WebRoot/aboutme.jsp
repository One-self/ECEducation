...
<div id="main">
		...
		<div class="bg_1_left">
			<div class="bg_1_left_top">
				<ul>
					...
					<li><a href="toAboutMe" class="active">与我相关</a></li>
					<li><a href="toMyAttitude">我的赞</a></li>
				</ul>
			</div>
 ...
 -->
			...
			<div class="bg_bottom">
				<div class="isay">
					<span>我评论的</span><hr style="filter:alpha(opacity=100,finishopacity=0,style=2)" color="#fc92a4" />
					<%
						List msgCmtMaps = (List)(session.getAttribute("msgCmtMaps"));
						for (int index=0; index<msgCmtMaps.size(); ++index) {
							Object msgMapObj = msgCmtMaps.get(index);
				...
				<div class="yousay">
					<span>被评论的</span><hr style="filter:alpha(opacity=100,finishopacity=0,style=2)" color="#fc92a4" />
					<%
						List msgCmtedMaps = (List)(session.getAttribute("msgCmtedMaps"));
						for (int index=0; index<msgCmtedMaps.size(); ++index) {
							Object msgMapObj = msgCmtedMaps.get(index);
							Map msgMap = (Map)msgMapObj;
						%>
							<div class="share_content">
								<div class="share_content_1">
				...
				<!-- <div class="share_content">
						<div class="share_content_1">
							<img src="images/3.jpg" width="120px" height="120px" />
						</div>
						<div class="share_content_2">
							<h3>lalala</h3>
							<h6>time</h6>
							<p>djgvsdjfgdf.gjvkl/xfgmvkldxlkfml/</p>
						</div>
						<div class="share_content_bottom">
							<div id="dianji"><img id="pinlun" src="images/message.png" width="25px" height="25px" /></div>
							<img src="images/dianzan.png" width="25px" height="25px" />
				...
				<div class="share_content">
						...
						<div class="share_content_bottom">
							<img src="images/message.png" width="25px" height="25px" />
							<img src="images/dianzan.png" width="25px" height="25px" />
						</div> 
				</div>
				<div class="share_content">
